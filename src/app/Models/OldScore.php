...
class OldScore extends Score {

	protected $table = 'highscores_OLD';

    protected $softDelete = false;

	protected $fillable = array('score_id', 'track_id', 'user_id', 'score', 'max_streak', 'max_multiplier', 'notes_hit', 'notes_missed', 'performance_data', 'play_mode', 'keylog', 'reload_count');
	...
	{
		$latest_scores_ids = Redis::connection()->lrange('last_highscores_ids',0,$count-1);
